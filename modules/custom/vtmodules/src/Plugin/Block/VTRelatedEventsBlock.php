 ...
 *
 * @Block(
 *   id = "vtrelated_events_block",
 *   admin_label = @Translation("Events Related"),
 *   category = @Translation("VT Events Related Block")
 * )
 */
class VTRelatedEventsBlock extends BlockBase {
