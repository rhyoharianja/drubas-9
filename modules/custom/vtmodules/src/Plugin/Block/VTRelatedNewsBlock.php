 ...
 *
 * @Block(
 *   id = "vtrelated_news_block",
 *   admin_label = @Translation("News Related"),
 *   category = @Translation("VT News Related Block")
 * )
 */
class VTRelatedNewsBlock extends BlockBase {
